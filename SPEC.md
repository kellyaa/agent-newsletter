...
CREATE TABLE topics_covered (  -- reserved stub for future cross-day topic dedup; not yet written to (issue #4)
  topic TEXT NOT NULL,           -- short slug, emitted by ranker (design intent)
  date TEXT NOT NULL,
