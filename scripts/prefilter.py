...
from rubric_hash import invalidate_stale_scores
...
def main() -> int:
    ...
    # Delegated to rubric_hash module — prefilter doesn't need to know the
    # ranker's prompt file path or hash storage details.
    invalidate_stale_scores(conn)
