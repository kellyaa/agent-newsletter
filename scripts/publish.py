...
def main() -> int:
    ...
    # items_candidate: everything the ranker considered for today — captured
    # BEFORE the UPDATE ... status='published' below, or featured/appendix
    # rows would already have been promoted out of view.
